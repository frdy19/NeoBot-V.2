...
let handler = async (m, { conn, args, text, usedPrefix, command, isROwner }) => {
    ...
    const domain = 'https://panel.theifwd.com'
    const apikey = 'ptla_t2yqXlmmy8RvIoCNOolRlwbVxtsSVNbLMXD694E6BDu';
    const c_apikey = 'ptlc_3KcOjiYcImsCxwJmyx0ifxBLyzYFgFqLYmfO5jY3FjU'
    switch (command) {
        case 'addusr': {
...
> Perintah :\n${usedPrefix + command} nomor/tag`);
            ...
            let dms = '6289518887904@s.whatsapp.net';
